<script>
    ...
    const options = ["Liberal", "Conservative", "Moderate", "Libertarian", "Other"];
  </script>
  
  <header>
    <div>Happen</div>
    <div class="setting">
      <img src="/image/settings_icon.png" height="28" width="28" />
    </div>
  </header>
    ...
    <div class="register_content">
      <form action="signin.php" method="post">
        <div class="form-group">
          <label for="political-affiliation">Political Affiliation:</label>
          <select id="political-affiliation" name="politicalAffiliation" bind:value={politicalAffiliation} required>
      ...
      <a href="profile7.html">
        <button class="signin" type="submit" name="login">Next</button>
      </a>
    </div>
  </div>
