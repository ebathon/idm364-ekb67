<script>
	...
	function toggleHideDrinkingHabits() {
		hideDrinkingHabits = !hideDrinkingHabits;
	}
</script>
...
<div class="container">
	<div class="header">
		...
		<div class="drinking-title">
			<h1>Drinking Habits <span class="drink-icon">🍸</span></h1>
		</div>
	</div>
	...
	<div class="form-container">
		...
		<div class="hide-option">
			<button 
				class="toggle-button {hideDrinkingHabits ? 'active' : ''}" 
				on:click={toggleHideDrinkingHabits}
			>
